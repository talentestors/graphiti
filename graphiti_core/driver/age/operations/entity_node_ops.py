...
class AGEEntityNodeOperations(EntityNodeOperations):
    async def save(
        self,
        ...
        query = get_entity_node_save_query(GraphProvider.AGE, labels)
    ...
    async def save_bulk(
        ...
        query = get_entity_node_save_bulk_query(GraphProvider.AGE, prepared)
    ...
    async def delete(
        ...
        # OPTIONAL MATCH is supported by AGE
        query = """
            MATCH (n {uuid: $uuid})
    ...
    async def delete_by_group_id(
        ...
        # AGE does not support Neo4j's CALL ... IN TRANSACTIONS OF $batch_size ROWS.
        # Batched deletion is handled in Python via multiple calls.
        query = """
    ...
    async def delete_by_uuids(
        ...
        # Batched deletion via UNWIND — safer for large lists in AGE
        query = """
            MATCH (n:Entity)
